...
public class StackoverflowWebClientTest {
    ...
    public void testFetchQuestion() {
        ...
        StackoverflowWebClient stackOverflowWebClient = new StackoverflowWebClient(webClient);

        // Assert
        StepVerifier.create(stackOverflowWebClient.fetchQuestion(questionId, sort, order))
            // Then
