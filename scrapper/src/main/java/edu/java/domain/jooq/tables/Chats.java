...
public class Chats extends TableImpl<ChatsRecord> {
    ...
    /**
     * The column <code>CHATS.TELEGRAM_CHAT_ID</code>.
     */
    public final TableField<ChatsRecord, Long> TELEGRAM_CHAT_ID =
        createField(DSL.name("TELEGRAM_CHAT_ID"), SQLDataType.BIGINT.nullable(false), this, "");
    /**
