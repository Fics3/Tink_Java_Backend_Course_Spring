...
public class Links extends TableImpl<LinksRecord> {
     ...
     */
    public final TableField<LinksRecord, UUID> LINK_ID =
    ...
    public final TableField<LinksRecord, String> LINK =
        createField(DSL.name("LINK"), SQLDataType.VARCHAR(1000000000), this, "");
    /**
     ...
     */
    public <U> SelectField<U> mapping(Function4<? super UUID, ? super String, ? super OffsetDateTime, ? super OffsetDateTime, ? extends U> from) {
    ...
    public <U> SelectField<U> mapping(
        Class<U> toType,
        Function4<? super UUID, ? super String, ? super OffsetDateTime, ? super OffsetDateTime, ? extends U> from
    ) {
