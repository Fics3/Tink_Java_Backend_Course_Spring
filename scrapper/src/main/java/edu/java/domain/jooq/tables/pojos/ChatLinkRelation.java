...
public class ChatLinkRelation implements Serializable {
    ...
    public ChatLinkRelation(ChatLinkRelation value) {
    ...
    public boolean equals(Object obj) {
        ...
        final ChatLinkRelation other = (ChatLinkRelation) obj;
        if (this.chatId == null) {
    ...
    public String toString() {
        StringBuilder sb = new StringBuilder("ChatLinkRelation (");
